...
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("Nayelly", 26))
...
print("Imprimimos todos los nombres de la base de datos")
alumno = conexion.execute("select * from alumnos")
# Traemos todo
